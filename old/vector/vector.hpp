...
namespace ft
{
	...
	class vector
	{
		...
		*/
		...
		/* Member functions */
			...
			/* Constructor */
		vector() : memory(Allocator), curr_capacity(0ul), array(NULL), curr_size(0ul) {}
	...
	{
		// TO DO: Check if i must return the remaining elems of the total cap
		return (size_type(curr_capacity - curr_size));
	}
